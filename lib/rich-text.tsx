              ...
              <div className="flow-root whitespace-pre-wrap break-words bg-gray-50 p-4 font-mono text-[0.78em] text-gray-800 dark:bg-white/5 dark:text-brand-dark">
                {entry.image?.url && (
                  /* Decorative thumbnail: floats only from sm up, so text
                     ...
                     hiding it there costs nothing. mt-1.5 corrects for the
                  ...
                  <span
                    aria-hidden="true"
                    className="relative mt-1.5 mb-1 mr-3 hidden h-[52px] w-[78px] overflow-hidden rounded-md shadow-md ring-1 ring-black/10 sm:float-left sm:block"
                  >
                    <ContentfulImage
                      src={entry.image.url}
                      alt=""
